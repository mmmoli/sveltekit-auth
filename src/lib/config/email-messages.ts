...
export const sendVerificationEmail = async (email: string, token: string) => {
	...
	// const resultSend = await sendEmail({ to: email, subject, html: htmlEmail, text: textEmail });
	return resultSend.ok;
};
...
export const updateEmailAddressSuccessEmail = async (
	...
	const subject = `Please confirm your email address for ${APP_NAME}`;
	// await sendEmail({ to: email, subject, html: htmlEmail, text: textEmail });
	...
	// const resultTwoSend = await sendEmail({
	// 	to: email,
	// 	subject: subjectChange,
	// 	html: htmlEmailChange,
	// 	text: textEmailChange
	// });
	return resultTwoSend.ok;
};
